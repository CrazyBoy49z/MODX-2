...
class SlotmachineOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('slotmachine_item_err_ns');
        }
...
return 'SlotmachineOfficeItemUpdateProcessor';
